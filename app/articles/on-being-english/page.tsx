        ...
        <RevealOnView intensity="soft">
          <div className="space-y-6">
            ...
            <p className="text-base text-neutral-500 dark:text-neutral-400 font-mono italic">
              This is the post colonial cognitive dissonance.
            </p>
            ...
            <div className="space-y-6 text-neutral-700 dark:text-neutral-300 font-mono text-base leading-relaxed text-justify">
              <p>
                This is the post colonial cognitive dissonance. I&apos;m physically in India which used to be a former colony of the English. Colonization is an irreversible process is what I&apos;m accepting. A systemic erosion of resources of a land only leaving a corroded system left to be in constant political instability. In India, English is the currency and capital and I accept it. The colonizer could be only confronted with the colonizers language. When I travel across India, the more I see the colonial remnants and it is sad. Around the turn of adolescene I got exposed to rock music which I clinged on for trauma release and naturally the music became part of my DNA. The strong relation I formed with the soul of David Gilmour and how I lately matched with the frequency of George Harrison. The land of Surrey which I considered a &quot;holy land&quot; where the musicians like Eric Clapton and Roger Waters channeled the ambience of the English countryside. What is 1947? It is just an illusion. The more I live in India, the cognitive dissonance is heavy. My soul is deeply drawn to the land of the music that is in my DNA. When I was cycling in the morning, I thought of the George Harrison&apos;s spirit which I&apos;m possessed with. It could be a pipe dream or delusion but that&apos;s me.
              </p>
            </div>
